...
## 鸣谢 (Credits)
> 本项目是基于 Lucifer 的开源项目 `simple_hsv_sliders` 进行深度修改和适配的版本。特此鸣谢原作者提供的优秀色彩滑块交互设计！原版可通过 Krita Artists 论坛获取：[Lucifer @ Krita Artists](https://krita-artists.org/u/Lucifer)。
